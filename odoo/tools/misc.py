...
DEFAULT_REMOTE_DATE_FORMAT = "%Y%m%d"
DEFAULT_REMOTE_TIME_FORMAT = "%H:%M:%S"
DEFAULT_REMOTE_DATETIME_FORMAT = "%sT%s" % (
    DEFAULT_REMOTE_DATE_FORMAT,
    DEFAULT_REMOTE_TIME_FORMAT
)
